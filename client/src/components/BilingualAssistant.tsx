...
function InjuryReportingMode() {
    ...
    if (summaryRef.current) {
      ...
      if (printWindow) {
        printWindow.document.write(`
          ...
          <div class="field"><span class="label">Description:</span><div class="value">${data.description || "N/A"}</div></div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="text-xs text-gray-400 mb-1 block">Description / Descripción</label>
        <Textarea
          className="bg-gray-800/60 border-gray-700 text-white placeholder:text-gray-500 min-h-[80px]"
          placeholder="Describe what happened / Describa lo que sucedió"
