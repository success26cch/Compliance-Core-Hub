...
const ORANGE_10 = "hsl(24,95%,53%,0.10)";
const ORANGE_20 = "hsl(24,95%,53%,0.20)";
const ORANGE_35 = "hsl(24,95%,53%,0.35)";
...
export default function MeetIsa() {
  return (
    <div
      ...
      style={{
        background: "linear-gradient(160deg, hsl(222,47%,9%) 0%, hsl(222,60%,6%) 50%, hsl(215,50%,8%) 100%)",
        color: "white",
      }}
    ...
    >
      ...
      <div
        className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full opacity-[0.07] blur-[120px]"
        style={{ background: ORANGE }}
      />
      <div
        className="pointer-events-none absolute top-80 right-0 w-[400px] h-[400px] rounded-full opacity-[0.05] blur-[100px]"
        style={{ background: "hsl(210,80%,60%)" }}
      />

      {/* ── Nav ── */}
      <nav className="relative z-10 border-b border-white/10 px-6 py-4 flex items-center justify-between backdrop-blur-sm">
        <Link href="/">
          <button
        ...
        >
          <div className="flex justify-center mb-6">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, hsl(24,95%,53%,0.18) 0%, hsl(24,95%,53%,0.06) 100%)",
                border: "1px solid hsl(24,95%,53%,0.3)",
                boxShadow: "0 0 40px hsl(24,95%,53%,0.15)",
              }}
            >
          ...
          <div
            ...
            style={{ background: ORANGE_10, border: `1px solid ${ORANGE_20}`, color: ORANGE }}
          >
          ...
          <h1
            ...
            style={{
              background: `linear-gradient(135deg, #ffffff 0%, hsl(24,95%,75%) 60%, ${ORANGE} 100%)`,
          ...
          <p className="text-lg text-white/80 font-semibold mb-4">
        ...
        >
          {STATS.map((s, i) => (
            <div
              ...
              style={{ background: ORANGE_10, border: `1px solid ${ORANGE_20}` }}
              data-testid={`stat-isa-${i}`}
            >
              <p
