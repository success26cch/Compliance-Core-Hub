...
function CoreyApp() {
  ...
  const DOCUMENT_TEMPLATES = [
    ...
    { label: "ISO 9001 Quality Manual", prompt: "Generate a comprehensive ISO 9001:2015 Quality Manual template. Include sections for: quality policy, scope of the QMS, context of the organization (Clause 4), leadership and commitment (Clause 5), planning for risks and opportunities (Clause 6), support and resources (Clause 7), operational controls (Clause 8), performance evaluation and internal audit (Clause 9), and improvement (Clause 10). Reference the 7 Quality Management Principles and PDCA cycle. Format as a professional quality manual ready for customization." },
    { label: "ISO 14001 Environmental Policy", prompt: "Generate a complete ISO 14001:2015 Environmental Management System Policy and Program document. Include: environmental policy statement with commitment to protection of the environment and pollution prevention, significant environmental aspects and impacts identification methodology, compliance obligations register framework, environmental objectives and targets, operational controls for significant aspects, emergency preparedness and response procedures, lifecycle perspective considerations, and monitoring/measurement framework. Format as a professional EMS document." },
    { label: "ISO 45001 OH&S Program", prompt: "Generate a comprehensive ISO 45001:2018 Occupational Health & Safety Management System Program document. Include: OH&S policy with commitment to safe working conditions and elimination of hazards, worker consultation and participation procedures (Clause 5.4), hazard identification and risk assessment methodology, hierarchy of controls implementation guide, legal requirements register framework, emergency preparedness and response, incident investigation procedures, management of change process, contractor OH&S requirements, and internal audit programme. Format as a professional OH&S program document." },
    { label: "Internal Audit Procedure (ISO 19011)", prompt: "Generate a complete Internal Audit Procedure based on ISO 19011:2018 guidelines. Include: audit programme management, audit planning and scheduling, auditor competence and impartiality requirements, audit execution steps (opening meeting, evidence collection, finding classification, closing meeting), nonconformity classification (major, minor, observation/OFI), corrective action tracking and verification, audit report template, follow-up audit procedures, and management review inputs. Applicable to ISO 9001, 14001, 45001, and integrated management systems." },
    { label: "IATF 16949 PPAP Checklist", prompt: "Generate a comprehensive Production Part Approval Process (PPAP) checklist per IATF 16949 and the AIAG PPAP Manual (4th Edition). Include all 18 PPAP elements: design records, engineering change documents, customer engineering approval, DFMEA, process flow diagram, PFMEA, control plan, MSA studies, dimensional results, material/performance test results, initial process studies (Cpk/Ppk), qualified laboratory documentation, AAR, sample parts, master sample, checking aids, customer-specific requirements, and Part Submission Warrant. Include submission level requirements (Levels 1-5) and customer notification/submission triggers." },
    { label: "Corrective Action Report (8D)", prompt: "Generate a comprehensive 8D Corrective Action Report template for ISO management systems and IATF 16949. Include all 8 disciplines: D0 (Emergency Response/Planning), D1 (Team Formation), D2 (Problem Description — Is/Is Not analysis), D3 (Interim Containment Actions), D4 (Root Cause Analysis — 5 Whys, Fishbone/Ishikawa), D5 (Permanent Corrective Actions), D6 (Implementation and Validation), D7 (Preventive Actions — systemic changes), D8 (Team Recognition and Close-Out). Include sections for effectiveness verification, lessons learned, and FMEA/Control Plan updates." },
    { label: "Management Review Agenda (IMS)", prompt: "Generate a comprehensive Management Review Meeting Agenda template for an Integrated Management System covering ISO 9001, ISO 14001, and ISO 45001. Include all required inputs per each standard: status of previous actions, changes in internal/external issues, QMS/EMS/OH&S performance data (KPIs, objectives, nonconformities, audit results, customer satisfaction, supplier performance, environmental compliance, incident trends, worker consultation feedback), resource adequacy, risk/opportunity effectiveness, and improvement opportunities. Include required outputs: improvement decisions, resource needs, and changes to the management system." },
  ];
