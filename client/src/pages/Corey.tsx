...
function CoreyApp() {
  ...
  const QUICK_ACTIONS = [
    ...
    },
    {
      ...
      prompt: "A user is interested in a Gap Analysis for their compliance programs or ISO management system. Gap Analysis is a core service provided by ACSI (Assessment & Consulting Services Inc.), our dedicated ISO and compliance consulting division. Please explain what a Gap Analysis involves — covering ISO 9001, 14001, 45001, and OSHA compliance program reviews — and let them know that ACSI's Lead ISO Auditors specialize in conducting thorough gap analyses, audit preparation, and implementation support. You can answer general questions about what gap analysis covers, but for the actual structured assessment, direct them to ACSI. At the end of your response, always include a clear call-to-action directing them to ACSI with the following: Visit ACSI online at www.acsi-quality.com or call them directly at (555) 123-4567 to schedule your gap analysis. Format the website as a clickable link: [www.acsi-quality.com](https://www.acsi-quality.com/). Let them know they can also reach ACSI through the CCH platform under the ACSI ISO Manager section.",
    },
    {
