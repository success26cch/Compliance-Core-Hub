            ...
            <div key={idx} className={`flex gap-3 ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
              ...
              <div className="group relative">
                ...
                {msg.role === "assistant" && msg.content && !isStreaming && (
                  <div className="absolute -bottom-5 left-2 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-3">
                    <button
                      onClick={async () => {
                        try {
                      ...
                      className="text-white/30 hover:text-white/60 flex items-center gap-1 text-xs"
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 text-xs ${speakingMsgIdx === idx ? 'text-accent' : 'text-white/30 hover:text-white/60'}`}
