...
const TOUR_SLIDES: TourSlide[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "23 Document Templates", detail: "Generate policies, permits, meeting tools, and assessments on demand — all CFR-referenced" },
  ...
  },
  {
    ...
    description: "Corey can generate 23 different compliance documents organized into four categories. Each template is backed by the exact CFR standard it references. Generate, review, download as PDF, email, or print — all from within the chat.",
    features: [
      { label: "Policies & Programs (8)", detail: "Drug & Alcohol Policy, OSHA Recordkeeping SOP, Respiratory Protection, Hearing Conservation, HazCom, LOTO, Bloodborne Pathogens, Forklift Safety" },
      { label: "Permits & Forms (4)", detail: "Confined Space Entry Permit, Hot Work Permit, JHA Template, Contractor Pre-Qualification Form" },
  ...
  },
  {
    ...
    subtitle: "$299/month — Up to 50 employees (+$2/employee beyond 50)",
    icon: Building2,
