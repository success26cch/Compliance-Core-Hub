...
import { Plus, Pencil, Trash2, ShieldAlert, Bot, ChevronDown, ChevronUp, Link2, AlertTriangle, Cog } from "lucide-react";
...
export default function RiskAssessmentModule({ isoProjectId }: { isoProjectId?: number }) {
  ...
  const cleanUpContextImports = async () => {
    const stale = risks.filter(r => r.linkedProcess === "4.1 Context of the Organization");
