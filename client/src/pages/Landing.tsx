      ...
      <nav className="bg-[hsl(222,47%,11%)] sticky top-0 z-[9999]">
        <div className="flex items-center justify-between h-12 px-4 gap-2">
          <div className="flex items-center gap-1 overflow-x-auto whitespace-nowrap scrollbar-hide flex-1">
            ...
            <Link href="/dashboard" className="px-3 py-2 text-sm font-bold bg-[#8B0000] text-white rounded-md hover:bg-[#a00000] transition-colors shrink-0 animate-pulse shadow-lg shadow-red-900/60" data-testid="nav-employer-dashboard">Employer Dashboard</Link>
