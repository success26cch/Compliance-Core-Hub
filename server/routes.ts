...
Write a formal scope statement paragraph using ${orgName}'s actual products/services and ${orgAddr || "its facility"}. ${hasDesign ? "" : `State clearly that Design and Development (Clause 8.3${isIATF ? "/IATF 8.3" : ""}) is excluded from this QMS because products are manufactured exclusively to customer-provided specifications.`}
Write a second paragraph listing the factors considered in determining the scope (internal/external issues from 4.1, requirements of interested parties from 4.2, the organization's products and services, and the boundaries and applicability of the QMS).${isIATF ? "\nNote that the scope also considers customer-specific requirements (CSRs) from automotive customers and the requirements of IATF 16949:2016." : ""}
...
4.4.2 — One paragraph stating that the organization determines, maintains, and retains documented information necessary to support process operation and provide confidence that processes are carried out as planned, per Procedure QP-7.5-1.${isIATF ? "\nNote IATF 16949 supplemental: ${orgName} also maintains a Manufacturing Feasibility review process and Corporate Responsibility Statement as required by customer-specific requirements." : ""}
...
5.1.1 General — Write 3 paragraphs on how top management actively leads and demonstrates commitment to the QMS: establishing policies and objectives, ensuring resource availability, promoting the process approach and risk-based thinking, communicating the importance of QMS effectiveness, directing improvement activities. Reference the Leadership Commitment Statement (FM-5.1-1).${isIATF ? " Top management also ensures customer-specific requirements are understood throughout the organization and maintains corporate accountability for product safety and regulatory compliance." : ""}
...
6.1.1 — Write 2 paragraphs on how ${orgName} identifies risks and opportunities by considering its organizational context (Section 4.1) and the needs of interested parties (Section 4.2). Explain the risk identification methodology and how risks are categorized and prioritized. Reference Risk Register (FM-6.1-1).
6.1.2 — Write 2 paragraphs on how actions to address identified risks and opportunities are planned and integrated into QMS processes. Explain how the effectiveness of these actions is evaluated through internal audits, management review, and ongoing monitoring. Reference Corrective Action Procedure (QP-10.2-1) and Risk Assessment Procedure (QP-6.1-1).${isIATF ? "\nIATF supplemental: ${orgName} maintains a formal risk management process that considers contingency planning, product safety risks, and manufacturing process risk as required by IATF 16949 clause 6.1.2.1." : ""}
...
Write 1 substantive paragraph. Describe how ${orgName} plans and controls changes to the QMS: identifying the purpose and potential consequences of changes, ensuring resource availability, assigning responsibilities, and maintaining QMS integrity during change. Reference Change Management Procedure (QP-6.3-1).
...
7.1  Resources
7.1.1 General — Write 1 paragraph on how ${orgName} determines and provides the resources needed for QMS establishment, implementation, maintenance, and continual improvement, considering both internal capabilities and resource constraints.
...
7.1.3 Infrastructure — Write 1 paragraph on facilities, equipment, and technology maintained by ${orgName} to achieve product conformity. Reference Preventive Maintenance Procedure (PM-7.1.3-1).
...
7.1.5 Monitoring and Measurement Resources — Write 2 paragraphs on the calibration program: what instruments are calibrated, the calibration cycle, records maintained, and traceability to national/international standards. Reference Calibration Procedure (QP-7.1.5-1) and Calibration Log (FM-7.1.5-1).${isIATF ? " Include reference to measurement system analysis (MSA) as required by IATF 16949 clause 7.1.5.1." : ""}
7.1.6 Organizational Knowledge — Write 1 paragraph on how ${orgName} identifies, maintains, and shares the organizational knowledge necessary to operate its processes and achieve product/service conformity.

7.2  Competence
Write 2 paragraphs on the competence management process: how required competencies are defined for each role, how employee competency is assessed, how training gaps are addressed, and how training effectiveness is verified. Reference Training and Competence Procedure (QP-7.2-1) and Training Records (FM-7.2-1).${isIATF ? "\nIATF supplemental: ${orgName} also maintains documented processes for on-the-job training (OJT) and maintains training records for all personnel affecting product quality per IATF 16949 clause 7.2.1 and 7.2.3." : ""}
...
7.5.1 General — Write 1 paragraph listing the documented information ${orgName} maintains and retains (including all mandatory documents and records required by ${standard}${isIATF ? ":2016" : ":2015"}).
...
7.5.3 Control of Documented Information — Write 2 paragraphs on distribution, access control, storage, protection, retrieval, retention periods, and disposition of documented information. Reference QP-7.5-1.${isIATF ? " Include note on IATF 16949 clause 7.5.3.2 requirements for record retention to meet statutory, regulatory, and customer-specified retention requirements." : ""}
...
Write 2 paragraphs on how ${orgName} plans, implements, controls, maintains, and reviews its operational processes. Describe criteria for process control, resources, documented information, monitoring activities, and control of outsourced processes.${isIATF ? "\nIATF supplemental: ${orgName} conducts manufacturing feasibility reviews for new products and changes using Form FM-8.1-1. Contingency plans are maintained per IATF 16949 clause 8.1.1." : ""}

8.2  Requirements for Products and Services
8.2.1 Customer Communication — Write 2 paragraphs on how ${orgName} communicates with customers regarding product/service information, order handling, customer feedback, complaints, customer property, and contingency actions.${isIATF ? " Include processes for communicating with customers on customer-specific requirements, PPAP submissions, and production part approval." : ""}
...
8.5.1 Control of Production and Service Provision — Write 3 paragraphs on the controlled conditions maintained during production: documented work instructions, use of monitoring/measuring equipment, implementation of monitoring and measurement activities, use of suitable infrastructure, qualified personnel, and validation/revalidation of processes.${isIATF ? " Reference the Control Plan (QP-8.5.1-CP) as the primary document defining process controls for each product. Include reference to IATF 16949 clause 8.5.1.1 (Control Plan) requirements." : ""}
...
8.5.4 Preservation — Write 1 paragraph on how ${orgName} preserves product conformity during internal processing and delivery to intended destination.
...
9.1.1 General — Write 2 paragraphs on what ${orgName} monitors and measures, the methods used, when monitoring/measurement is performed, and when results are analyzed and evaluated. Reference KPI Dashboard (FM-9.1-1).
...
10.1  General
Write 1 paragraph on ${orgName}'s commitment to continually improving the suitability, adequacy, and effectiveness of the QMS — including consideration of analysis results, audit findings, and management review outputs.

10.2  Nonconformity and Corrective Action
Write 3 paragraphs on the full corrective action process: reacting to nonconformity (containment and correction); determining root cause; implementing corrective actions; verifying effectiveness of actions; updating risk register and documented information as needed; sharing lessons learned. Reference Corrective Action Procedure (QP-10.2-1), Corrective Action Request Form (FM-10.2-1), and 8D Problem Solving Report (FM-10.2-2).${isIATF ? "\nIATF supplemental: ${orgName} utilizes AIAG-recommended problem-solving methodologies (8D, 5-Why, Fishbone/Ishikawa) and ensures timely customer notification of corrective actions per customer-specific requirements." : ""}
