  ...
  app.post("/api/iso-compliance-obligations/bulk-md", async (req: Request, res: Response) => {
    ...
    try {
      ...
      const MD_STARTER_LIBRARY = [
        ...
        { requirementName: "FDA 21 CFR 820.75 — Process Validation", citationSource: "21 CFR Part 820.75", jurisdictionLevel: "F", aspectCategory: "Validation & Installation", regulatoryFramework: "FDA_21CFR_820", mdRegulatory: true, validationRequired: true, reportingTimeline: "Validate before production release; revalidate on changes", standard: "FDA 21 CFR 820 — QSR", descriptionOfRequirement: "Where results of a process cannot be fully verified by subsequent inspection and test, validate process with a high degree of assurance.", complianceStatus: "compliant" },
        { requirementName: "FDA 21 CFR 820.22 — Quality Audit", citationSource: "21 CFR Part 820.22", jurisdictionLevel: "F", aspectCategory: "Internal Audit", regulatoryFramework: "FDA_21CFR_820", mdRegulatory: true, reportingTimeline: "At least annually", standard: "FDA 21 CFR 820 — QSR", descriptionOfRequirement: "Establish procedures for quality audits and conduct such audits to assure that the quality system is in conformity with the established quality system requirements.", complianceStatus: "compliant" },
        // FDA Medical Device Reporting (MDR) — 21 CFR Part 803 (federal reporting law)
        { requirementName: "FDA MDR 803.50 — Reportable Events (30-Day)", citationSource: "21 CFR Part 803.50", jurisdictionLevel: "F", aspectCategory: "Regulatory Reporting", regulatoryFramework: "FDA_MDR", mdRegulatory: true, reportingTimeline: "30 calendar days from awareness", standard: "FDA 21 CFR 820 — QSR", descriptionOfRequirement: "Report to FDA within 30 calendar days after becoming aware of information that reasonably suggests that a device has caused or contributed to a serious injury or death.", complianceStatus: "compliant" },
        { requirementName: "FDA MDR 803.53 — Five-Day Reports", citationSource: "21 CFR Part 803.53", jurisdictionLevel: "F", aspectCategory: "Regulatory Reporting", regulatoryFramework: "FDA_MDR", mdRegulatory: true, reportingTimeline: "5 business days", standard: "FDA 21 CFR 820 — QSR", descriptionOfRequirement: "Report within 5 business days if MDW requires remedial action or if FDA requests a 5-day report for an event type.", complianceStatus: "compliant" },
        { requirementName: "FDA MDR 803.56 — Supplemental Reports", citationSource: "21 CFR Part 803.56", jurisdictionLevel: "F", aspectCategory: "Regulatory Reporting", regulatoryFramework: "FDA_MDR", mdRegulatory: true, reportingTimeline: "Within 1 year of initial MDR or as required", standard: "FDA 21 CFR 820 — QSR", descriptionOfRequirement: "Submit supplemental reports when additional information is obtained after initial MDR submission.", complianceStatus: "compliant" },
        { requirementName: "FDA MDR — Annual Baseline Report (803.55)", citationSource: "21 CFR Part 803.55", jurisdictionLevel: "F", aspectCategory: "Regulatory Reporting", regulatoryFramework: "FDA_MDR", mdRegulatory: true, reportingTimeline: "January 1 each year", standard: "FDA 21 CFR 820 — QSR", descriptionOfRequirement: "Submit annual baseline report for each device type that had an MDR reportable event in the previous year.", complianceStatus: "compliant" },
        // EU Medical Device Regulation 2017/745 (EU law)
        { requirementName: "EU MDR Art. 87 — Serious Incident Reporting", citationSource: "EU MDR 2017/745 Art. 87", jurisdictionLevel: "F", aspectCategory: "Regulatory Reporting", regulatoryFramework: "EU_MDR", mdRegulatory: true, reportingTimeline: "Immediately / 15 days / 30 days depending on severity", standard: "EU MDR 2017/745", descriptionOfRequirement: "Report serious incidents and field safety corrective actions to national competent authorities in applicable EU member states.", complianceStatus: "compliant" },
        { requirementName: "EU MDR Art. 83 — Post-Market Surveillance", citationSource: "EU MDR 2017/745 Art. 83", jurisdictionLevel: "F", aspectCategory: "Post-Market Surveillance", regulatoryFramework: "EU_MDR", mdRegulatory: true, reportingTimeline: "PMS Plan reviewed at least annually; PMCF as required", standard: "EU MDR 2017/745", descriptionOfRequirement: "Establish, implement, document, and maintain a PMS system proactively collecting and reviewing experience from devices placed on the market.", complianceStatus: "compliant" },
        { requirementName: "EU MDR Art. 85-86 — PSUR / Periodic Safety Update", citationSource: "EU MDR 2017/745 Art. 85-86", jurisdictionLevel: "F", aspectCategory: "Post-Market Surveillance", regulatoryFramework: "EU_MDR", mdRegulatory: true, reportingTimeline: "Class I: when needed; Class IIa/IIb: at least every 2 years; Class III/implantable: annually", standard: "EU MDR 2017/745", descriptionOfRequirement: "Prepare and update PSUR summarizing the results and conclusions of the PMS data analysis and benefit-risk determination.", complianceStatus: "compliant" },
      ];
